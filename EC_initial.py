...
class CelebA(Dataset):
    def __init__(self, img_dir, label_root):
        ...
        #The label of the image which loads the labels array of the image
        #self.label_root = np.load(label_root)
        self.label_root = np.genfromtxt(label_root, delimiter=",", skip_header=True)
        self.root = img_dir
...
if __name__ == '__main__':
    ...
    parser.add_argument('-img_dir', type=str, default='E:\Deep Obfuscator\CelebA\img_align_celeba\img_align_celeba',
                        help='image dictionary path')
    parser.add_argument('-label_root', type=str, default='E:\Deep Obfuscator\CelebA\list_attr_celeba.csv',
